"""Batch-quantize triangulated polygon samples into RVQ indices."""
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Batch-quantize triangle shard samples into RVQ indices")
