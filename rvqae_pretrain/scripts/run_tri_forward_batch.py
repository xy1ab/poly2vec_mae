...
def main() -> None:
    ...
    parser.add_argument("--nicft", type=int, default=64, help="ICFT output size. <=0 disables ICFT export.")
    ...
    parser.add_argument("--rec_flag", type=bool, default=False, help="Save rasterized triangle mask.")
