"""Decode RVQ index batches back into reconstructed frequency maps."""
...
def main() -> None:
    ...
    if __package__ in {None, ""}:
        ...
        PolyRvqDecodePipeline = importlib.import_module("rvqae_pretrain.src.engine.pipeline").PolyRvqDecodePipeline
    else:
        from ..src.engine.pipeline import PolyRvqDecodePipeline

    parser = argparse.ArgumentParser(description="Decode quantized RVQ indices into frequency maps")
