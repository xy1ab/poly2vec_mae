"""Magnitude/phase reconstruction losses for RVQAE pretraining.

This module implements the dual magnitude loss (base + high-frequency penalty)
and phase loss used in polygon RVQAE training.
"""
...
def compute_mag_phase_losses(
    ...
    """Compute RVQAE magnitude and phase losses on full frequency images.

    Args:
        pred_imgs: RVQAE reconstructed frequency images `[B,3,H,W]`.
