"""Checkpoint save/export helpers for AE pretraining.
...
def export_model_bundle(
    ...
    Args:
        ...
        run_name: Folder name for this export (e.g., `ae_20260407_1200`).
        run_config: Training configuration to persist.
        full_state_dict: Full AE checkpoint state dict.
    ...
    save_checkpoint(export_dir / "autoencoder.pth", full_state_dict, precision=checkpoint_precision)
