"""Dataset package for AE pretraining.
...
_LAZY_EXPORTS: dict[str, tuple[str, str]] = {
    "PolyAEDataset": (".polygon_dataset", "PolyAEDataset"),
    "PolyMAEDataset": (".polygon_dataset", "PolyMAEDataset"),
    ...
    "ae_collate_fn": (".collate", "ae_collate_fn"),
    "mae_collate_fn": (".collate", "mae_collate_fn"),
