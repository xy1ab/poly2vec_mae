...
triangle-shard workflow. New AE reconstruction visualization should prefer
`scripts/run_eval.py`.
"""
...
def eval_main(args) -> None:
    ...
    """
    print("[WARN] `src.engine.evaluator` is legacy. Prefer `scripts/run_eval.py` for AE reconstruction visualization.")
